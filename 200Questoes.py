...
print("QUESTÃO 143 \n\t Dada a função densidade de probabilidade f(x) = 3x² para 0 ≤ x ≤ 1, encontre a média da distribuição.\n\tResposta", 0.75, ", A média é o valor esperado E(X).\n")
print("QUESTÃO 144 \n\t Uma variável aleatória X tem uma distribuição normal com média 10 e desvio padrão 2. Calcule a probabilidade de X ser maior que 12.\n\tResposta", 0.1587, ", Usamos a função de distribuição acumulada para normal.\n")
print("QUESTÃO 145 \n\t Considere uma variável aleatória contínua X com distribuição uniforme no intervalo [0, 4]. Calcule a variância de X.\n\tResposta", 1.3333, ", A variância de X é calculada por Var(X) = (b-a)^2/12.\n")
print("QUESTÃO 146 \n\t Se X é uma variável aleatória exponencial com taxa λ = 2, qual é a função de densidade de probabilidade de X?\n\tResposta", "2e^(-2x)", ", A densidade exponencial é λe^(-λx).\n")
print("QUESTÃO 147 \n\t Encontre a mediana de uma distribuição normal com média 0 e desvio padrão 1.\n\tResposta", 0, ", A mediana de uma normal padrão é a própria média.\n")
print("QUESTÃO 148 \n\t Calcule a probabilidade de uma variável aleatória normal padrão estar entre -1 e 1.\n\tResposta", 0.6827, ", Usamos a tabela de distribuição normal padrão.\n")
print("QUESTÃO 149 \n\t Dada a distribuição exponencial com média 5, calcule a probabilidade de X ser menor que 2.\n\tResposta", 0.3297, ", Usamos a função acumulada de uma exponencial.\n")

print("QUESTÃO 150 \n\t Se X ~ U(2, 8), qual é a função de distribuição acumulada F(x) para X?\n\tResposta", "(x-2)/6", ", Para X uniforme, F(x) é linear.\n")
print("QUESTÃO 151 \n\t Encontre a moda de uma distribuição triangular com valores de suporte [0, 4] e pico em 2.\n\tResposta", 2, ", A moda é o pico da distribuição.\n")
print("QUESTÃO 152 \n\t Qual é a curtose de uma distribuição normal?\n\tResposta", 3, ", A distribuição normal tem curtose de 3.\n")
print("QUESTÃO 153 \n\t Se a média amostral de uma distribuição normal é 50, com desvio padrão populacional 10 e n=25, qual é o erro padrão da média?\n\tResposta", 2, ", O erro padrão é σ/√n.\n")
print("QUESTÃO 154 \n\t Uma amostra aleatória de 100 observações tem média 200 e desvio padrão 15. Encontre o intervalo de confiança de 95% para a média populacional.\n\tResposta", "[197.06, 202.94]", ", Usamos a fórmula do intervalo de confiança para médias.\n")
print("QUESTÃO 155 \n\t Uma amostra de 40 indivíduos tem uma média de 6. Encontre a variância amostral se o desvio padrão é 2.\n\tResposta", 4, ", A variância é o quadrado do desvio padrão.\n")
print("QUESTÃO 156 \n\t Qual é a distribuição amostral da média se a amostra é retirada de uma população normal com média μ e variância σ²?\n\tResposta", "Normal(μ, σ²/n)", ", A média amostral de uma normal é normal.\n")
print("QUESTÃO 157 \n\t Se temos uma amostra de 64 observações com média 20 e variância 16, qual é o intervalo de confiança de 95% para a média populacional?\n\tResposta", "[18.04, 21.96]", ", Usamos a distribuição t para o intervalo de confiança.\n")
print("QUESTÃO 158 \n\t Calcule o intervalo de confiança de 99% para a média se a amostra de 50 tem média 100 e desvio padrão 20.\n\tResposta", "[93.02, 106.98]", ", O intervalo de confiança é dado por média ± z * (σ/√n).\n")
print("QUESTÃO 159 \n\t Se a variância amostral de uma distribuição normal é 9 e n=36, qual é o intervalo de confiança de 95% para a variância populacional?\n\tResposta", "[6.83, 13.91]", ", Usamos a distribuição qui-quadrado para variâncias.\n")

print("QUESTÃO 160 \n\t Dada uma amostra de 25 indivíduos com média 30 e desvio padrão 5, estime a média populacional com um nível de confiança de 90%.\n\tResposta", "[28.29, 31.71]", ", Usamos a distribuição t para pequenas amostras.\n")
print("QUESTÃO 161 \n\t Qual é a distribuição amostral da variância se a amostra é retirada de uma população normal com variância σ²?\n\tResposta", "Qui-quadrado", ", A variância amostral segue uma qui-quadrado.\n")
print("QUESTÃO 162 \n\t Se uma amostra aleatória de 50 observações tem uma média amostral de 60, calcule o erro padrão da média se a variância populacional é 16.\n\tResposta", 0.5657, ", O erro padrão é σ/√n.\n")
print("QUESTÃO 163 \n\t Uma variável aleatória X segue uma distribuição de Poisson com λ = 3. Calcule a probabilidade de X ser igual a 4.\n\tResposta", 0.1680, ", Usamos a fórmula da distribuição de Poisson.\n")
print("QUESTÃO 164 \n\t Se X ~ Binomial(n=10, p=0.5), qual é a probabilidade de X ser igual a 7?\n\tResposta", 0.1172, ", Usamos a fórmula da binomial P(X=k) = C(n,k) * p^k * (1-p)^(n-k).\n")
print("QUESTÃO 165 \n\t Dada uma variável aleatória discreta com distribuição geométrica e p = 0.2, encontre a probabilidade de X = 5.\n\tResposta", 0.0819, ", A fórmula da geométrica é (1-p)^(k-1) * p.\n")
print("QUESTÃO 166 \n\t Calcule a média de uma variável aleatória com distribuição binomial negativa com r = 4 e p = 0.3.\n\tResposta", 9.3333, ", A média de uma binomial negativa é r/p.\n")
print("QUESTÃO 167 \n\t Encontre a variância de uma distribuição de Poisson com λ = 7.\n\tResposta", 7, ", A variância de uma Poisson é igual ao parâmetro λ.\n")
print("QUESTÃO 168 \n\t Uma variável aleatória X tem distribuição hipergeométrica com N=20, K=5, n=10. Encontre a probabilidade de X ser igual a 3.\n\tResposta", 0.2663, ", Usamos a fórmula da distribuição hipergeométrica.\n")
print("QUESTÃO 169 \n\t Se X é uma variável aleatória com distribuição binomial negativa, r = 5 e p = 0.6, qual é a variância de X?\n\tResposta", 5.5556, ", A variância é r(1-p)/p².\n")

print("QUESTÃO 170 \n\t Uma variável aleatória segue uma distribuição uniforme discreta no conjunto {1, 2, 3, 4, 5}. Qual é a probabilidade de X ser menor ou igual a 3?\n\tResposta", 0.6, ", A probabilidade é dada por P(X ≤ 3) = 3/5.\n")
print("QUESTÃO 171 \n\t Encontre a moda de uma distribuição binomial com n=20 e p=0.7.\n\tResposta", 14, ", A moda é o valor de k que maximiza P(X=k).\n")
print("QUESTÃO 172 \n\t Se X ~ Poisson(λ=4), qual é a probabilidade de X ser maior que 2?\n\tResposta", 0.5665, ", Subtraímos P(X ≤ 2) de 1.\n")
print("QUESTÃO 173\n\t Uma variável aleatória X tem distribuição binomial com n=10 e p=0.3. Calcule a variância de X.\n\tResposta", 2.1, ", A variância da binomial é np(1-p).\n")
print("QUESTÃO 174\n\t Se X ~ Geométrica(p=0.25), qual é a probabilidade de X ser maior que 3?\n\tResposta", 0.4219, ", Usamos P(X > 3) = (1-p)^3.\n")
print("QUESTÃO 175\n\t Encontre a média de uma variável aleatória X com distribuição hipergeométrica, N=30, K=10, n=5.\n\tResposta", 1.6667, ", A média da hipergeométrica é n(K/N).\n")
print("QUESTÃO 176\n\t Se X ~ Binomial(15, 0.4), qual é a probabilidade de X ser menor ou igual a 5?\n\tResposta", 0.2977, ", Usamos a fórmula da distribuição binomial.\n")
print("QUESTÃO 177\n\t Uma variável aleatória discreta segue a distribuição de Poisson com λ = 4. Qual é a probabilidade de X ser igual a 0?\n\tResposta", 0.0183, ", Usamos P(X=0) = e^(-λ)λ^x/x!.\n")
print("QUESTÃO 178\n\t Se X segue uma distribuição binomial negativa com r = 3 e p = 0.5, qual é a probabilidade de X ser igual a 5?\n\tResposta", 0.1562, ", Usamos a fórmula da binomial negativa.\n")
print("QUESTÃO 179\n\t Calcule a variância de uma variável aleatória X com distribuição geométrica e p = 0.3.\n\tResposta", 7.7778, ", A variância da geométrica é (1-p)/p².\n")

print("QUESTÃO 180\n\t Uma variável aleatória segue uma distribuição de Poisson com λ = 2. Calcule a probabilidade de X ser menor ou igual a 3.\n\tResposta", 0.8571, ", Usamos a soma das probabilidades de P(X=0) até P(X=3).\n")
print("QUESTÃO 181\n\t Encontre a média de uma variável aleatória X com distribuição binomial com n=20 e p=0.25.\n\tResposta", 5, ", A média da binomial é np.\n")
print("QUESTÃO 182\n\t Se X segue uma distribuição hipergeométrica com N=50, K=20, n=10, qual é a variância de X?\n\tResposta", 1.6327, ", A variância é n(K/N)(1-K/N)(N-n)/(N-1).\n")
print("QUESTÃO 183\n\t Dada uma amostra de tamanho 30, testando se a média populacional é 50 com desvio padrão 5, qual é o valor crítico para um teste bilateral a 5% de significância?\n\tResposta", 1.96, ", Usamos a distribuição normal padrão.\n")
print("QUESTÃO 184\n\t Se a média amostral é 100 e desvio padrão 15, qual é o p-valor para um teste de hipótese onde H0: μ = 95 e Ha: μ ≠ 95?\n\tResposta", 0.0344, ", Usamos a estatística de teste z.\n")
print("QUESTÃO 185\n\t Calcule o poder de um teste se o tamanho da amostra é 50, α = 0.05, e a diferença esperada da média é 3.\n\tResposta", 0.7985, ", O poder é 1 - β.\n")
print("QUESTÃO 186\n\t Em um teste de hipótese para proporções, onde p0 = 0.5 e n = 100, qual é o p-valor se a proporção amostral é 0.55?\n\tResposta", 0.3642, ", Usamos a estatística de teste z para proporções.\n")
print("QUESTÃO 187\n\t Se X ~ Normal(0,1), qual é o valor crítico para um teste unilateral à esquerda com α = 0.01?\n\tResposta", -2.33, ", Usamos a tabela da distribuição normal padrão.\n")
print("QUESTÃO 188\n\t Um teste de hipótese bilateral com n = 25 e σ desconhecido, H0: μ = 10, Ha: μ ≠ 10, α = 0.05, qual é o valor crítico para t?\n\tResposta", 2.064, ", Usamos a distribuição t de Student.\n")
print("QUESTÃO 189\n\t Em um teste de hipótese para a variância, onde H0: σ² = 4, n = 30, qual é o valor crítico superior para α = 0.05?\n\tResposta", 46.979, ", Usamos a distribuição qui-quadrado.\n")

print("QUESTÃO 190\n\t Se o p-valor de um teste de hipótese é 0.03 e α = 0.05, qual é a decisão em relação a H0?\n\tResposta", "Rejeitar H0", ", Como p < α, rejeitamos H0.\n")
print("QUESTÃO 191\n\t Qual é o erro tipo I em um teste de hipótese?\n\tResposta", "Rejeitar H0 quando H0 é verdadeira", ", Erro tipo I ocorre quando rejeitamos H0 incorretamente.\n")
print("QUESTÃO 192\n\t Qual é o erro tipo II em um teste de hipótese?\n\tResposta", "Não rejeitar H0 quando H0 é falsa", ", Erro tipo II ocorre quando não rejeitamos H0 incorretamente.\n")
print("QUESTÃO 193\n\t Dado um experimento com dois tratamentos, como determinar se há diferença significativa entre eles usando ANOVA?\n\tResposta", "Comparando a estatística F com o valor crítico", ", ANOVA testa se as médias dos grupos são iguais.\n")
print("QUESTÃO 194\n\t Em um experimento com três grupos, qual é a hipótese nula para um teste de ANOVA?\n\tResposta", "As médias dos três grupos são iguais", ", ANOVA testa a igualdade das médias entre grupos.\n")
print("QUESTÃO 195\n\t Qual é a estatística usada para comparar dois tratamentos em um experimento pareado?\n\tResposta", "t de Student para amostras dependentes", ", Comparamos as médias das diferenças dos pares.\n")
print("QUESTÃO 196\n\t Se a estatística F em uma ANOVA é maior que o valor crítico, qual é a conclusão?\n\tResposta", "Rejeitamos H0", ", Concluímos que há uma diferença significativa entre os grupos.\n")
print("QUESTÃO 197\n\t Em um teste de hipótese para dois tratamentos, se o intervalo de confiança para a diferença de médias inclui 0, qual é a conclusão?\n\tResposta", "Não rejeitar H0", ", O intervalo que inclui 0 indica que a diferença pode não ser significativa.\n")
print("QUESTÃO 198\n\t Qual é a finalidade de um teste Tukey após uma ANOVA?\n\tResposta", "Identificar quais médias diferem", ", Tukey testa pares de médias para identificar diferenças significativas.\n")
print("QUESTÃO 199\n\t Em um experimento com três tratamentos e um nível de significância de 0.05, o p-valor obtido na ANOVA foi 0.02. Qual é a decisão?\n\tResposta", "Rejeitar H0", ", Como o p-valor é menor que 0.05, rejeitamos H0.\n")
print("QUESTÃO 200\n\t Se a diferença de médias entre dois tratamentos é significativa ao nível de 1%, qual é a conclusão ao nível de 5%?\n\tResposta", "Ainda rejeitamos H0", ", Significância a 1% implica significância a 5%.\n")
